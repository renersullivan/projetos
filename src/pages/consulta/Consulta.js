        ...
        <div className='consulta'>   
           ...
           <div className='container-right'>
                ...
                <div className='input-form'>
                    ...
                    <input className='input-card' type="text" id="User1"  />
                    <label for="User2">Nome Completo</label>
                    <input className='input-card' type="text" id="User2"  />
                    <label for="User3">Celular</label>
                    <input className='input-card' type="tel" id="User3"  />
                    <label for="User4">E-mail</label>
                    <input className='input-card' type="email" id="User4"  />
                    <label for="User5">Confirmação de e-mail</label>
                    <input className='input-card' type="email" id="User5"  />
                </div>
